...
window.onload = () => {
    function ajax() {
        ...
        xhr.onload = () => { //once ajax loaded
            ...
            if (xhr.status == 200 && xhr.status < 300) {
                ...
                title.innerText = "You're Currently Online!";
                subTitle.innerText = "Hurray! You are currently connected to the Internet.";
    ...
    function offline() { //function for offline
        ...
        subTitle.innerText = "Oops! You are currently disconnected from the Internet.";
        wifiIcon.innerHTML = '<i class="uil uil-wifi-slash"></i>';
    }

    setInterval(() => { //this setInterval function call ajax frequently after 1000ms or 1s
        ajax();
    }, 1000);
}